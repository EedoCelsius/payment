        ...
        >
          <div class="flex flex-col items-center gap-5">
            <div class="flex size-22 items-center justify-center rounded-3xl bg-surface-100/20 shadow-inner">
              <img
                :src="urlResolver(`${tossData.account.type === 'bank' ? 'banks' : 'securities'}/${tossData.account.firm}.svg`).value"
...
import { CopyWrapper, Spinner } from '@shared/components/base';
import { useCountdown, useUrlResolver } from '@shared/composables';
